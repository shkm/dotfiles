...
setTilixProfileKey "background-color" "'#272822'"
setTilixProfileKey "foreground-color" "'#F8F8F2'"
setTilixProfileKey "palette" "['#272822', '#F92672', '#A6E22E', '#F4BF75', '#66D9EF', '#AE81FF', '#A1EFE4', '#F8F8F2', '#75715E', '#F92672', '#A6E22E', '#F4BF75', '#66D9EF', '#AE81FF', '#A1EFE4', '#F9F8F5']"
