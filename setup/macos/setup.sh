...
# TODO: replace with a bundle approach
...
# brew install --cask signal jetbrains-toolbox font-jetbrains-mono-nerd-font zed itsycal chatgpt arc spotify obsidian shottr
