# Fixes fisher to work correctly with fisher_path.
# Loaded early so we can take advantage of plugins after.
# https://github.com/kidonng/fisher_path.fish/blob/master/conf.d/fisher_path.fish
